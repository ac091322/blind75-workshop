...
print(maxElement(3, 7, 1))  # output: 3
print(maxElement(4, 6, 2))  # output: 2
print(maxElement(5, 10, 0))  # output: 4
print(maxElement(6, 15, 3))  # output: 4
print(maxElement(10, 20, 5))  # output: 4
