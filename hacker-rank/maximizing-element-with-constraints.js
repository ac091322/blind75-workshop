...
console.log(maxElement(3, 7, 1)); // output: 3
console.log(maxElement(4, 6, 2)); // output: 2
console.log(maxElement(5, 10, 0)); // output: 4
console.log(maxElement(6, 15, 3)); // output: 4
console.log(maxElement(10, 20, 5)); // output: 4
